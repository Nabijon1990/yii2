...
return [
    ...
    'No' => 'Yo`q',
    'No help for unknown command "{command}".' => '"{command}" noaniq buyruq uchun ma`lumotnoma mavjud emas.',
    'No help for unknown sub-command "{command}".' => '"{command}" noaniq qism buyruq uchun ma`lumotnoma mavjud emas.',
    'No results found.' => 'Hech nima topilmadi.',
    'Only files with these MIME types are allowed: {mimeTypes}.' => 'Faqat quyidagi MIME-turidagi fayllarni yuklashga ruxsat berilgan: {mimeTypes}.',
    'Only files with these extensions are allowed: {extensions}.' => 'Faqat quyidagi kengaytmali fayllarni yuklashga ruxsat berilgan: {extensions}.',
    ...
    'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{item} other{items}}.' => 'Namoyish etilayapti <b>{begin, number}-{end, number}</b> ta yozuv <b>{totalCount, number}</b> tadan.',
    ...
    'Unknown command "{command}".' => '"{command}" noaniq buyruq.',
    'Unknown option: --{name}' => 'Noaniq opsiya: --{name}',
    'Update' => 'Tahrirlash',
    'View' => 'Ko`rish',
    'Yes' => 'Ha',
    'You are not allowed to perform this action.' => 'Sizga ushbu amalni bajarishga ruxsat berilmagan.',
